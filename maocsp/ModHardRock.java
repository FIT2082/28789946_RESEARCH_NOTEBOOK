...
//            score.ChangeArmure((score.GetArmure()+2)%7);
        ...
        if (nomnom.equals("range")) {
            ...
            else {                                      // Si range ne décrit pas un domaine de variable, il décrit un delta...
                if (to-from>8) {to=from+8;}             // Car il est possible d' avoir une réduction de 100 milliards de valeurs...
...
//            score.ChangeArmure((score.GetArmure()+2)%7);
    ...
    private int selectGamme(int n) {
        // ceci est défini très arbitrairement...
        switch (n) {                    // Maj  Min
