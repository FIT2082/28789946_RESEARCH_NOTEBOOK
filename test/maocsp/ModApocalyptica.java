...
public class ModApocalyptica extends DefaultHandler{
    ...
    Pattern[] rytm;         // COntiendra les differents pattern rythmiques jous par lengthpremier violoncelle
    ArrayList amettre;
...
// Demandes de renseignements propres au mode choisi...
    ...
    private int rythmAJouer() {
        if (Partage.nbvar==0) {System.out.println("pas de variables");return 0;}
            ...
            sum=sum/Partage.nbvar;  // sum= moyenne des cardinalits des domaines de variables
            sum--;
