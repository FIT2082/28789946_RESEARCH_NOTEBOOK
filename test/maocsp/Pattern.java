...
public class Pattern {
    ...
    ArrayList elems;
    /** renvoie la dure d' un element du pattern (Note ou Chord*/
    ...
    /** Ajoute une note  la fin du pattern*/
    public void AddNote(int degre,int duree) {
        elems.add(new Note(degre,duree));
    }
    
    /** ajoute un silence de duree divisions lmentaires  la fin du pattern */
    public void AddSilence(int duree) {
        elems.add(new Silence(duree));
    }
    
    /** Ajoute un accord  la fin du pattern*/
    ...
    /** retourne la dure du pattern (en divisions elementaires)*/
    ...
    /** ecrit le pattern sur la piste spcifie du MusicScore spcifi sur longueur divisions. Le rab de temps est combl par un silence */
